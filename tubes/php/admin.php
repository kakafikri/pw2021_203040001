...
<h1 style="text-align: center"><a href="admin.php" style="color:black">Admin</a></h1>
            ...
            <?php else : ?>
                ...
                <?php foreach ($baju as $bj) : ?>
                    ...
                    <td class="table-active"><?= $i; ?></td>
                        <td>
                            <button><a href="ubah.php?id=<?= $bj['id'] ?>" style="color:black;">Ubah</a></button>
                            <button><a href="hapus.php?id=<?= $bj['id'] ?> " onclick="return confirm('Hapus Data?')" style="color:black;">Hapus</a></button>
